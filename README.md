...
Для SPA реализованы сервисы аутентификации на основе cookie.  При анализе входящего HTTP-запроса Sanctum сначала проверяет наличие cookie-файла аутентификации, и если его нет, то проверяет заголовок Authorization на наличие действительного токена API.
